...
function ENT:Initialize()
	...
	self:SetModel( "models/mark2580/gtav/barstuff/whiskey_bottle_2.mdl" )
...
function ENT:Use( activator )
    ...
    if activator:IsPlayer() then
        ...
        netstream.Start(activator, "nut_whiskey_bottle", time)
        activator:SetHealth(math.Clamp(activator:Health() + 100, 0, activator:GetMaxHealth() + 100))
        activator:SetArmor(math.Clamp(activator:Armor() + 100, 0, 200))
        activator:notify("You feel very numb to pain")
