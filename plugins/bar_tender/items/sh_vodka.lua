ITEM.name = "Vodka"
ITEM.model = "models/mark2580/gtav/barstuff/cherenkov_01.mdl"
ITEM.width = 1
ITEM.height = 1
ITEM.price = 50
...
ITEM.functions.use = { 
	...
	onRun = function(item)
		...
		if client:IsPlayer() then
			...
			netstream.Start(client, "nut_vodka_bottle", time)
			client:SetHealth(math.Clamp(client:Health() + 100, 0, client:GetMaxHealth() + 100))
			client:SetArmor(math.Clamp(client:Armor() + 100, 0, 200))
			client:notify("You feel very numb to pain")
